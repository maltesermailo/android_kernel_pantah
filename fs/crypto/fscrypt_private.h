...
static inline int fscrypt_get_raw_secret(struct super_block *sb,
					 ...
					 unsigned int raw_secret_size)
{
	fscrypt_warn(NULL, "kernel built without support for wrapped keys");
	return -EOPNOTSUPP;
}
...
struct fscrypt_master_key_secret {
	...
	/* This denotes that the key in raw is a wrapped key. */
	bool is_wrapped_key;
	 ...
	 * this a wrapped key, in which case this contains the wrapped
	 * key rather than the key with which 'hkdf' was keyed.
	 */
