...
int fuse_open_common(struct inode *inode, struct file *file, bool isdir)
{
...
#ifdef CONFIG_FUSE_BPF
	{
		...
		fer = fuse_bpf_backing(inode, inode, struct fuse_open_io,
...
static int fuse_flush(struct file *file, fl_owner_t id)
{
	...
	fer = fuse_bpf_backing(file->f_inode, file->f_inode, struct fuse_flush_in,
...
static ssize_t fuse_file_read_iter(struct kiocb *iocb, struct iov_iter *to)
{
...
#ifdef CONFIG_FUSE_BPF
	{
		...
		fer = fuse_bpf_backing(inode, inode, struct fuse_file_read_iter_io,
...
static ssize_t fuse_file_write_iter(struct kiocb *iocb, struct iov_iter *from)
{
...
#ifdef CONFIG_FUSE_BPF
	{
		...
		fer = fuse_bpf_backing(inode, inode, struct fuse_file_write_iter_io,
...
static loff_t fuse_file_llseek(struct file *file, loff_t offset, int whence)
{
	...
	fer = fuse_bpf_backing(inode, inode, struct fuse_lseek_io,
				...
				loff_t length)
{
	...
	fer = fuse_bpf_backing(inode, inode, struct fuse_fallocate_in,
				      ...
				      size_t len, unsigned int flags)
{
	...
	fer = fuse_bpf_backing(file_in->f_inode, file_in->f_inode, struct fuse_copy_file_range_io,
