...
void fuse_open_initialize(struct fuse_args *fa, struct fuse_open_io *foi,
...
void fuse_lookup_initialize(struct fuse_args *fa, struct fuse_lookup_io *feo,
...
void fuse_setattr_initialize(struct fuse_args *fa, struct fuse_setattr_io *fsi,
...
void fuse_get_link_initialize(struct fuse_args *fa, struct fuse_dummy_io *dummy,
