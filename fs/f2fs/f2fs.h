...
{
        trace_android_rvh_get_pages_address(sbi, &count_type);
...
{
        trace_android_rvh_get_is_idle(sbi, &sbi->gc_mode, &type);
...
{
        trace_android_rvh_inode_flag_set(&flag);
...
{
        trace_android_rvh_set_is_file(&type);
