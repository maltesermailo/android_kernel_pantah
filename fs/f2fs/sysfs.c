...
<<<<<<< HEAD   (b0a4629c9d1bc5b7791ea5e60dddaebc14d4a3fb Merge 2f67ff1e15a8 ("f2fs: fix to avoid UAF in f2fs_write_en)
...
||||||| BASE   (2f67ff1e15a8a4d0e4ffc6564ab20d03d7398fe9 f2fs: fix to avoid UAF in f2fs_write_end_io())
	ui = (unsigned int *)(ptr + a->offset);
=======
	return __sbi_show_value(a, sbi, buf, ptr + a->offset);
}
>>>>>>> BRANCH (438a405fbad6882df0e34b3e1a16839a71f04240 f2fs: fix out-of-bounds access in sysfs attribute read/write)
