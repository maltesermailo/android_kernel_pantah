...
<<<<<<< HEAD   (5f92e5fdd1489e189206252cd830f7ad4d8c3bf9 Revert "Bluetooth: MGMT: Protect mgmt_pending list with its )
	trace_android_vh_tcp_rcv_rtt_update(tp, sample, win_dep);

	if (new_sample != 0) {
||||||| BASE   (23fdf46589db718d538fa3e65ab0d57362d50b4a Linux 6.12.34)
	if (new_sample != 0) {
=======
