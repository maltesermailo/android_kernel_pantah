...
static void handle___pkvm_hyp_pgtable_available(struct kvm_cpu_context *host_ctxt)
{
	cpu_reg(host_ctxt, 1) = pkvm_pgt_available();
}
...
static const hcall_t host_hcall[] = {
	...
	HANDLE_FUNC(__pkvm_hyp_pgtable_available),
};
