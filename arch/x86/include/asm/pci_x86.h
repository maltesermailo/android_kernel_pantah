 ...
 */
static inline unsigned char pci_mmcfg_readb(void __iomem *pos)
{
	u8 val;
...
static inline unsigned short pci_mmcfg_readw(void __iomem *pos)
{
	u16 val;
...
static inline unsigned int pci_mmcfg_readl(void __iomem *pos)
{
	u32 val;
...
static inline void pci_mmcfg_writeb(unsigned char val, void __iomem *pos)
{
	asm volatile("movb %%al,(%1)" : : "a" (val), "r" (pos) : "memory");
}

static inline void pci_mmcfg_writew(unsigned short val, void __iomem *pos)
{
	asm volatile("movw %%ax,(%1)" : : "a" (val), "r" (pos) : "memory");
}

static inline void pci_mmcfg_writel(unsigned int val, void __iomem *pos)
{
