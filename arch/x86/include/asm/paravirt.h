...
static __always_inline unsigned char pv_pci_mmcfg_readb(void __iomem *addr)
{
	return PVOP_CALL1(unsigned char, mmio.pci_mmcfg_readb, addr);
}

static __always_inline unsigned short pv_pci_mmcfg_readw(void __iomem *addr)
{
	return PVOP_CALL1(unsigned short, mmio.pci_mmcfg_readw, addr);
}

static __always_inline unsigned int pv_pci_mmcfg_readl(void __iomem *addr)
{
	return PVOP_CALL1(unsigned int, mmio.pci_mmcfg_readl, addr);
}

static __always_inline void pv_pci_mmcfg_writeb(unsigned char val, void __iomem *addr)
{
	PVOP_VCALL2(mmio.pci_mmcfg_writeb, val, addr);
}

static __always_inline void pv_pci_mmcfg_writew(unsigned short val, void __iomem *addr)
{
	PVOP_VCALL2(mmio.pci_mmcfg_writew, val, addr);
}

static __always_inline void pv_pci_mmcfg_writel(unsigned int val, void __iomem *addr)
{
