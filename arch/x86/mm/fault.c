...
good_area:
	...
	mmap_read_unlock(mm);
<<<<<<< HEAD   (4583a3c3ec1e58a1a40369c3716aea91fe04fe2d Revert "netlink: introduce NLA_POLICY_MAX_BE")

done:
	if (unlikely(fault & VM_FAULT_ERROR)) {
		mm_fault_error(regs, hw_error_code, address, fault);
||||||| BASE   (c1e4e2f1aede7c29cdd2b2fbd9cd090c3e75d7d8 scsi: scsi_transport_sas: Fix the maximum channel scanning i)
	if (unlikely(fault & VM_FAULT_ERROR)) {
		mm_fault_error(regs, hw_error_code, address, fault);
=======
	if (likely(!(fault & VM_FAULT_ERROR)))
>>>>>>> BRANCH (342aae6459e1d0631d990dd293887da755d1aa43 x86/fault: Fold mm_fault_error() into do_user_addr_fault())
		return;
