...
extern int trace_android_vh_snd_compr_use_pause_in_drain(bool *, bool *);
...
static inline int snd_compr_pause_in_drain(struct snd_compr_stream *stream,
...
static inline int snd_compr_resume_from_drain(struct snd_compr_stream *stream,
				bool leave_draining_state)
{
	int retval;
