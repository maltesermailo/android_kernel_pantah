...
<<<<<<< HEAD   (6f6441d9aa57fe509241727abf9727d132be6a72 Merge 6.1.155 into android14-6.1-lts)
		if (!dev)
||||||| BASE   (882efbdd9d34ebaf03da2dd0246f07f251b0aed2 Linux 6.1.155)
		if (!dev || !is_events_enabled(master, SVC_I3C_EVENT_IBI))
=======
		if (!dev || !is_events_enabled(master, SVC_I3C_EVENT_IBI)) {
>>>>>>> BRANCH (77ce71aaa02cab677671e434485834cbc8eb5e75 i2c: designware: Add disabling clocks when probe fails)
