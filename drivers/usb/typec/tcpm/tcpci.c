...
#define	VSRC_NEW_MIN_PERCENT			0.95
#define	VSRC_VALID_MIN_MV			500
#define	VPPS_NEW_MIN_PERCENT			0.95
#define	VPPS_VALID_MIN_MV			100
#define	VSINKDISCONNECT_PD_MIN_PERCENT		0.90
						   ...
						   bool pps_active, u32 requested_vbus_voltage_mv)
{
	...
	if (pwr_ctrl & TCPC_FAST_ROLE_SWAP_EN) {
		...
		if (pps_active)
			...
			threshold = (VSRC_NEW_MIN_PERCENT * requested_vbus_voltage_mv -
