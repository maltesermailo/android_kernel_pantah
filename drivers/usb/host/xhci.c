...
static int xhci_address_device_timeout(struct usb_hcd *hcd, struct usb_device *udev,
...
{
	return xhci_setup_device(hcd, udev, SETUP_CONTEXT_ADDRESS, XHCI_CMD_DEFAULT_TIMEOUT);
}
...
static const struct hc_driver xhci_hc_driver = {
	...
	.address_device_timeout =	xhci_address_device_timeout,
