...
static inline void trace_xhci_dbc_giveback_request(struct dbc_request *req)
{
}
static inline void trace_xhci_dbc_alloc_request(struct dbc_request *req)
{
}
static inline void trace_xhci_dbc_free_request(struct dbc_request *req)
{
}
static inline void trace_xhci_dbc_gadget_ep_queue(struct xhci_ring *ring, struct xhci_generic_trb *trb )
{
}
static inline void trace_xhci_dbc_queue_request(struct dbc_request *req)
{
}
static inline void trace_xhci_dbc_handle_transfer(struct xhci_ring *ring, struct xhci_generic_trb *trb )
{
}
static inline void trace_xhci_dbc_handle_event(struct xhci_ring *ring, struct xhci_generic_trb *trb )
{
}
#ifdef CONFIG_PM
