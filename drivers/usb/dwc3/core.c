...
int dwc3_core_soft_reset(struct dwc3 *dwc)
{
	...
	trace_android_vh_dwc3_core_soft_reset(dwc, PRE_SOFT_RESET);
	...
	trace_android_vh_dwc3_core_soft_reset(dwc, SOFT_RESET_INITIATED);
	...
	trace_android_vh_dwc3_core_soft_reset(dwc, POST_SOFT_RESET);
