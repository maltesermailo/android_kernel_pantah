...
extern void __android_set_connected(struct android_uevent_opts *opts, bool connected);
extern void __android_set_configured(struct android_uevent_opts *opts, bool configured);
