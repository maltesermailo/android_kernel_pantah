...
TRACE_DEFINE_ENUM(TIPC_CHANNEL_CONNECTED);
TRACE_DEFINE_ENUM(TIPC_CHANNEL_DISCONNECTED);
TRACE_DEFINE_ENUM(TIPC_CHANNEL_SHUTDOWN);

#define tipc_channel_event_name(event) \
        __print_symbolic(event, \
                { TIPC_CHANNEL_CONNECTED, "TIPC_CHANNEL_CONNECTED" }, \
                { TIPC_CHANNEL_DISCONNECTED, "TIPC_CHANNEL_DISCONNECTED" }, \
                { TIPC_CHANNEL_SHUTDOWN, "TIPC_CHANNEL_SHUTDOWN" })
...
TRACE_EVENT(trusty_ipc_handle_event,
	...
	TP_printk("chan=%u srv_name=%s event=%s", __entry->chan, __entry->srv_name, tipc_channel_event_name(__entry->event_id))
);
