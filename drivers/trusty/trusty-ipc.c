...
static int new_shared_handle(struct tipc_shared_handle **shared_handle)
{
...
static int drop_shared_handle(struct tipc_shared_handle *shared_handle)
{
	int ret;
...
static void register_shared_handle_locked(struct tipc_shared_handle *new_handle)
{
...
static void register_shared_handle(struct tipc_shared_handle **shared_handle)
{
...
take_shared_handle_locked(trusty_shared_mem_id_t obj_id)
{
...
static struct tipc_shared_handle *take_shared_handle(trusty_shared_mem_id_t
						     obj_id)
{
