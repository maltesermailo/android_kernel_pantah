...
static void hvm_ioevent_release(struct hvm_ioevent *p)
{
...
static bool hvm_ioevent_in_range(struct hvm_ioevent *p, uint64_t addr,
 ...
 */
bool hvm_ioevent_write(struct hvm_vcpu *vcpu, uint64_t addr, int len,
			const void *val)
{
