...
struct AshmemSysfsAttrs {
    ...
    attr_prot: bindings::kobj_attribute,
...
static ATTRS: AshmemSysfsAttrs = AshmemSysfsAttrs {
    ...
    attr_prot: attribute(c_str!("prot_mask"), 0o644, prot_show, prot_store),
    attr_array: [
        addr_of!(ATTRS.attr_unpin.attr).cast_mut(),
        addr_of!(ATTRS.attr_prot.attr).cast_mut(),
        ptr::null_mut(),
    ],
};
...
#[export_name = "ashmem_prot_store"]
unsafe extern "C" fn prot_store(
    _kobj: *mut bindings::kobject,
    _attr: *mut bindings::kobj_attribute,
    buf: *const u8,
    count: usize,
    ...
    match crate::prot_set(buf) {
        Ok(()) => count as isize,
        Err(err) => err.to_errno() as isize,
    }
}

#[export_name = "ashmem_prot_show"]
unsafe extern "C" fn prot_show(
    _kobj: *mut bindings::kobject,
    _attr: *mut bindings::kobj_attribute,
    buf: *mut u8,
) -> isize {
    let value = crate::prot_get();
