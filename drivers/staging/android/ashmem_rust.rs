...
#[cfg(CONFIG_COMPAT)]
#[no_mangle]
unsafe extern "C" fn ashmem_memfd_ioctl_compat(
    ...
    unsafe { ashmem_memfd_ioctl(file, cmd, arg) }
}
...
fn ashmem_memfd_ioctl_inner(file: &File, cmd: u32, arg: usize) -> Result<isize> {
    ...
    match cmd {
        ...
        bindings::ASHMEM_SET_PROT_MASK | bindings::COMPAT_ASHMEM_SET_PROT_MASK => {
        ...
        bindings::COMPAT_ASHMEM_SET_SIZE => Err(EINVAL),
        _ => Err(EINVAL),
    }
}
