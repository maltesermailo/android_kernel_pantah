...
static int heap_id;
/*
 * Since this is intended for Android supporting only 64-bit architectures
 * it is safe to use u64 here, otherwise atomic_long_t should be used.
 */
static u64 total_heap_bytes;
