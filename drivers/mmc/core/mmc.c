...
EXPORT_SYMBOL(mmc_select_bus_width);
...
EXPORT_SYMBOL(mmc_select_hs_ddr);
...
EXPORT_SYMBOL(mmc_select_hs400);
...
EXPORT_SYMBOL(mmc_select_timing);
...
EXPORT_SYMBOL(mmc_hs200_tuning);
