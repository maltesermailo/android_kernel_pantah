...
static struct attribute *dsu_pmu_event_attrs[] = {
  ...
  DSU_EVENT_ATTR(acp_cycles, 0x11b),
  DSU_EVENT_ATTR(acp_access_rd, 0x160),
  DSU_EVENT_ATTR(acp_access_wr, 0x161),
  DSU_EVENT_ATTR(ppt_access, 0x219),
  DSU_EVENT_ATTR(pp_cycles, 0x21d),
  DSU_EVENT_ATTR(pp_access_rd, 0x260),
  DSU_EVENT_ATTR(pp_access_wr, 0x261),
  DSU_EVENT_ATTR(scu_snp_access, 0xc00),
  DSU_EVENT_ATTR(scu_snp_evict, 0xc01),
  DSU_EVENT_ATTR(scu_snp_no_cpu_snp, 0xc02),
  ...
  DSU_EVENT_ATTR(scu_stash_icn_dropped, 0x515),
  DSU_EVENT_ATTR(scu_stash_acp_access, 0x520),
  DSU_EVENT_ATTR(scu_stash_acp_miss, 0x521),
  DSU_EVENT_ATTR(scu_stash_acp_hit, 0x522),
  DSU_EVENT_ATTR(scu_hzd_address, 0x0d0),
  DSU_EVENT_ATTR(scu_bib_access, 0x0f3),
  DSU_EVENT_ATTR(scu_back_invalidate, 0x0f4),
  DSU_EVENT_ATTR(scu_bib_ecc, 0x0f5),
	NULL,
};
