...
<<<<<<< HEAD   (7513f3 UPSTREAM: usb: typec: tcpm: Add support for altmodes)
	/* WQ_UNBOUND greatly improves performance when running on ramdisk */
<<<<<<< PATCH SET (2ae280 UPSTREAM: dm verity: stop using WQ_UNBOUND for verify_wq)
...
>>>>>>> CHANGE (4966ae UPSTREAM: dm verity: stop using WQ_UNBOUND for verify_wq)
=======
...
>>>>>>> BASE      (7a3927 BACKPORT: dm verity: enable WQ_HIGHPRI on verify_wq)
	if (!v->verify_wq) {
