...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_free_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_after_enqueue_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_after_dequeue_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_RB_enqueue_entity);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_RB_dequeue_entity);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_check_preempt_tick_two);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_check_preempt_wakeup_two);
