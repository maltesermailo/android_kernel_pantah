...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_add_page_mapcount_to_op_lrulist);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_account_page_mapcount);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dec_page_mapcount_to_op_lrulist);
