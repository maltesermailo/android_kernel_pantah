...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_has_work);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_thread_write);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_wait_for_work_entry);
