...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_release);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_prepare_req_desc_hdr);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_queuecommand_first);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_queuecommand_second);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_queuecommand_third);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_queuecommand_fourth);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_set_queue_depth);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_change_queue_depth);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_compl_command_second);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_abort_first);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_abort_second);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_init);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_memory_alloc);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_host_memory_configure);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufshcd_init_lrb);
