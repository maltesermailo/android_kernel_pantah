...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_subdev_set_selection);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_subdev_set_fmt);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_subdev_set_frame_interval);
