...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_to_avail_list);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_del_from_avail_list);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh___cgroup_throttle_swaprate);
