...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_apply_wqattrs_prepare);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_blk_mq_raise_softirq);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_blk_mq_submit_bio);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_verity_end_io);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh___do_softirq);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_sort_wait_q);
