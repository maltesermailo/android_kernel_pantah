...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_hc_manager_destroy);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_hotness_decide);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_hotness_maintain);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_hc_manager_restart);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_hc_manager_init);
