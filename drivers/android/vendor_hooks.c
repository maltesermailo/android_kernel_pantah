...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_try_to_wake_up_out);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tick_entry);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_schedule);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_migrate_tasks);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_migrate_tasks_end);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_rq_cpu_starting);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_clear_request);
