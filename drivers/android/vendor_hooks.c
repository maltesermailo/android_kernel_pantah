...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_softirq_entry);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_softirq_exit);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_irq_entry);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_irq_exit);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_smp_call_entry);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_smp_call_exit);
