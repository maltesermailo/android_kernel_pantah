...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_iomap_dio_bio_end_io);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_verity_end_io);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_read_end_io);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_write_end_io);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_z_erofs_submissionqueue_endio);
