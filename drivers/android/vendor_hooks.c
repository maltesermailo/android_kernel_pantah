...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_mcq_is_enabled);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_ufs_mcq_alloc_priv);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_mcq_map_tag);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_mcq_set_sqid);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_mcq_init_irq);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_ufs_mcq_hba_capabilities);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_ufs_mcq_memory_alloc);
