...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_free_mod_mem);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_set_mod_perm_after_init);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_set_mod_perm_before_init);
