...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_stop_checkpoint_get_meta);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_stop_checkpoint_wb_cp_data);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_stop_checkpoint_get_inode);
