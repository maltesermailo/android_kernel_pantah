...
<<<<<<< PATCH SET (5f6c2b48d546985f00a2226b21babe42f6d51b7d ANDROID: Add vendor hook for tracking folios during readahea)
...
||||||| BASE      (0e2f5877a7d62b9167ea6edc35f72c5474307521 ANDROID: vendor_hook: Added hook to tune reclaimed huge page)
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_report_bug);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wp_page_reuse);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_cache_readahead_start);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_cache_readahead_end);
...
>>>>>>> BASE      (c2c58aed73b13d86a97edd74e86924cb96167572 ANDROID: vendor_hook: Added hook to tune reclaimed huge page)
