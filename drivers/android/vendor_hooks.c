...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_update_mapped_mul);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_add_mapped_mul_op_lrulist);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dec_mapped_mul_op_lrulist);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_should_be_protect);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_mapped_page_try_sorthead);
