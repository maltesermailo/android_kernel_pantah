...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tcp_srtt_estimator);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tcp_retransmit_timer);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tcp_v4_init_sock);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tcp_v4_destroy_sock);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_tcp_v6_init_sock);
