...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_update_partition_status);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_sd_update_cmdline_timing);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_sd_update_dataline_timing);
