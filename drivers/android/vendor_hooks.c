...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_audio_usb_offload_set_rate);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_audio_usb_offload_pcmbuf);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_audio_usb_offload_pcm_intf);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_audio_usb_offload_pcm_control);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_audio_usb_offload_pcm_binterval);
