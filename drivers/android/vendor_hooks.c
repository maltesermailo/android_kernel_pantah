...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wakeup_kshrink_lruvecd);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_setpage_reclaim_trylock);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_clearpage_reclaim_trylock);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_reclaim_trylock_fail);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_reclaim_page_trylock);
