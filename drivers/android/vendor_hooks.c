...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_count_vma_counter);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_vma_counter);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_vma_hot);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_access_page);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_vma_flag_process);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_process_page_states);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_page_referenced_one);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_update_swap_ref_cnt);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_count_swpout_vm_event);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_shmem_unuse_swap_entries);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_swap_slot_cache_active);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_swap_slots_cache);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_alloc_slots);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_free_swap_slot);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_swap_slot_info);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_swap_page);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_madvise_case_memfusion);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_madvise_vma);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_inactive_is_low);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_page_check_references);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_snapshot_refaults);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_shrink_page_list);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_to_swap);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_nr_swap_pages);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_dec_nr_swap_pages);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_set_page_hot);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_nr_total_swap_pages);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_init_swap_info_struct);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_swp_hot_flag);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_swap_size);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_si_swapinfo);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_nr_swapfiles);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_swap_avail_heads);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_scan_swap_map_slots);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_swap_alloc_cluster);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_memfusion_use);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_memfusion_get);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_vm_area_alloc);
