...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_skip_swapcache_flags);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_gfp_zone_flags);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_readahead_gfp_mask);
