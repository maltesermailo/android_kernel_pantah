 ...
 * of proc->threads, proc->waiting_threads, proc->requested_threads,
 * proc->requested_threads_started, proc->nodes, proc->todo
 * and invariant fields, elements are protected by proc->outer_lock
 */
struct binder_proc {
	...
	struct list_head waiting_threads; /* protected by inner lock */
	int pid;
	...
	int max_threads;
	int requested_threads; /* protected by inner lock */
	int requested_threads_started; /* protected by inner lock */
