 ...
 *
 * Given a node, get the refs if the proc hasn't already died. Also,
 * take a tmpref on @proc if valid
 *
 * Return: The target_node with refs or NULL if no proc. Also
 *         sets @proc if valid. If the proc had died, @error
 *         is set to BR_DEAD_REPLY
 */
