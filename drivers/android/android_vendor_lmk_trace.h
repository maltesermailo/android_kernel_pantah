...
#if !defined(_ANDROID_VENDOR_LMK_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define _ANDROID_VENDOR_LMK_TRACE_H
...
#endif /* _ANDROID_VENDOR_LMK_TRACE_H */

#undef TRACE_INCLUDE_PATH
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_PATH .
#define TRACE_INCLUDE_FILE android_vendor_lmk_trace
