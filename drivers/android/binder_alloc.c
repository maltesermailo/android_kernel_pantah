...
<<<<<<< HEAD   (dad6868f0c118913906b24f2bc7b56f73fd3dd62 ANDROID: Move SCX_OPS_DISABLING VH inside the scx_fork_rwsem)
	spin_unlock(&alloc->lock);
||||||| BASE   (6ffad426f89f06e271a8484db32649193f2a9e3e BACKPORT: Revert "binder: switch alloc->mutex to spinlock_t")
	mutex_unlock(&alloc->mutex);
=======
>>>>>>> CHANGE (0ed8ebbac68ec9714c0ae5208dc30126665a9973 BACKPORT: binder: concurrent page installation)
	spin_unlock(lock);
