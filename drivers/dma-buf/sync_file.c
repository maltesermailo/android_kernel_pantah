...
<<<<<<< TARGET BRANCH (aef1d593fd1003e897d53660fc450aa404bfb498 UPSTREAM: dma-fence: Add helpers for accessing driver and ti)
...
=======
		snprintf(buf, len, "%s-%s%llu-%lld",
			 ...
			 fence->context,
			 fence->seqno);
>>>>>>> SOURCE BRANCH (6e0e285b22f1b092388649a82d63b9d092a317f0 UPSTREAM: sync_file: Use dma-fence driver and timeline name )
	}
