...
<<<<<<< PATCH SET (feab3c ANDROID: mm: gcma: support statistics)
}
...
module_init(gcma_init);
>>>>>>> CHANGE (99f382 ANDROID: mm: gcma: support statistics)
||||||| BASE
=======
...
module_init(gcma_init);
>>>>>>> CHANGE (c0cef6 ANDROID: mm: gcma: integrate with CMA)
>>>>>>> BASE      (8826db ANDROID: mm: gcma: integrate with CMA)
