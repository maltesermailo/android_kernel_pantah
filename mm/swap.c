...
<<<<<<< HEAD   (7d95e47409e22831956b62620a80ca2d9b668c90 Reapply "xfrm: Duplicate SPI Handling")
	if (lru_gen_enabled() && lru_gen_clear_refs(folio))
		return;

	folio_batch_add_and_move(folio, lru_deactivate_file, true);
||||||| BASE   (da274362a7bd9ab3a6e46d15945029145ebce672 Linux 6.12.49)
	folio_batch_add_and_move(folio, lru_deactivate_file, true);
=======
	folio_batch_add_and_move(folio, lru_deactivate_file);
>>>>>>> BRANCH (72b82d56b82137a92a20e5584029d35408d810c2 Linux 6.12.50)
}
