...
static int __init setup_kmalloc_64_create(char *str)
{
	if (IS_ALIGNED(64, cache_line_size()))
		kmalloc_64_create = true;

	return 1;
}
__setup("kmalloc_64_create", setup_kmalloc_64_create);
...
bool kmalloc_64_create __ro_after_init;
EXPORT_SYMBOL_GPL(kmalloc_64_create);
