...
const int mmap_rnd_bits_min = CONFIG_ARCH_MMAP_RND_BITS_MIN-2;
const int mmap_rnd_bits_max = CONFIG_ARCH_MMAP_RND_BITS_MAX-2;
int mmap_rnd_bits __read_mostly = CONFIG_ARCH_MMAP_RND_BITS-2;
#endif
#ifdef CONFIG_HAVE_ARCH_MMAP_RND_COMPAT_BITS
const int mmap_rnd_compat_bits_min = CONFIG_ARCH_MMAP_RND_COMPAT_BITS_MIN-2;
const int mmap_rnd_compat_bits_max = CONFIG_ARCH_MMAP_RND_COMPAT_BITS_MAX-2;
int mmap_rnd_compat_bits __read_mostly = CONFIG_ARCH_MMAP_RND_COMPAT_BITS-2;
#endif
