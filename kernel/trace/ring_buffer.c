...
{
<<<<<<< HEAD   (ffe2e1362e9b65847d18ed9aee64cfc4a4aa38b3 ANDROID: GKI: Update abi.stg files)
...
=======
	struct ring_buffer_cpu_meta *meta = cpu_buffer->ring_meta;
	struct buffer_page *head_page;
>>>>>>> BRANCH (0acceb1cfc3e8b7670c429a12f7887402430caac UPSTREAM: ring-buffer: Add buffer meta data for persistent r)
