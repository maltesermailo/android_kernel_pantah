...
static inline void sync_rcu_exp_select_cpus_schedule_work(struct rcu_node *rnp)
{
...
static inline void synchronize_rcu_expedited_schedule_work(struct rcu_exp_work *rew)
{
...
static void sync_rcu_exp_select_cpus(void)
{
	...
	rcu_for_each_leaf_node(rnp) {
		...
		sync_rcu_exp_select_cpus_schedule_work(rnp);
...
void synchronize_rcu_expedited(void)
{
	...
	if (unlikely(boottime)) {
		...
		rew.rew_s = s;
		synchronize_rcu_expedited_schedule_work(&rew);
	}
