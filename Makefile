...
# Make sure we're using a supported toolchain with SAFESTACK
ifdef CONFIG_SAFESTACK
  ifneq ($(call clang-ifversion, -ge, 0600, y), y)
	@echo Cannot use CONFIG_SAFESTACK: requires clang 6.0 or later >&2 && exit 1
  endif
endif
# Make sure compiler supports SafeStack flags
