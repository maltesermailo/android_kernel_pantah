...
#ifdef CONFIG_ANDROID_VENDOR_DATA_PADDING
...
#define android_init_vendor_data(p, n)
#endif /* CONFIG_ANDROID_VENDOR_DATA_PADDING */

#ifdef CONFIG_ANDROID_OEM_DATA_PADDING
...
#define android_init_oem_data(p, n)
#endif /* CONFIG_ANDROID_OEM_DATA_PADDING */
...
#define ANDROID_OEM_DATA_ARRAY(n, s)
#define android_init_oem_data(p, n)
#endif /* CONFIG_ANDROID_STRUCT_PADDING */
