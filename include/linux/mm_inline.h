...
void lruvec_add_folio(struct lruvec *lruvec, struct folio *folio)
{
	...
	trace_android_vh_mm_lru_add_priv_folio(lruvec, lru, folio, false, &skip);
	if (skip)
		return;
...
void lruvec_add_folio_tail(struct lruvec *lruvec, struct folio *folio)
{
	...
	trace_android_vh_mm_lru_add_priv_folio(lruvec, lru, folio, true, &skip);
	if (skip)
		return;
...
void lruvec_del_folio(struct lruvec *lruvec, struct folio *folio)
{
	...
	trace_android_vh_mm_lru_del_priv_folio(lruvec, lru, folio, &skip);
	if (skip)
		return;
