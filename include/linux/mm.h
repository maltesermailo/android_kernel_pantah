...
#define VM_NR_EVICTED_BIT1	(_AC(1,ULL) << 61)	/* Bit1 of Pages evicted from end of VMA */
#define VM_NR_EVICTED_BIT2	(_AC(1,ULL) << 62)	/* Bit2 of Pages evicted from end of VMA */
