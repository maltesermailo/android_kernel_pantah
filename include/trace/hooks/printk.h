...
DECLARE_HOOK(android_vh_printk_encode_caller,
	TP_PROTO(u32 *caller_id, int *cus_caller),
	TP_ARGS(caller_id, cus_caller));
DECLARE_HOOK(android_vh_printk_decode_caller,
