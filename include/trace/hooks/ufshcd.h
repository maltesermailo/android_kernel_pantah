...
DECLARE_HOOK(android_vh_ufs_mcq_is_enabled,
	TP_PROTO(struct ufs_hba *hba, bool *enabled),
	TP_ARGS(hba, enabled));

DECLARE_RESTRICTED_HOOK(android_rvh_ufs_mcq_alloc_priv,
...
DECLARE_HOOK(android_vh_ufs_mcq_init_irq,
	TP_PROTO(struct ufs_hba *hba),
	TP_ARGS(hba));
...
DECLARE_RESTRICTED_HOOK(android_rvh_ufs_mcq_hba_capabilities,
	TP_PROTO(struct ufs_hba *hba, int *err),
	TP_ARGS(hba, err), 1);

DECLARE_RESTRICTED_HOOK(android_rvh_ufs_mcq_memory_alloc,
