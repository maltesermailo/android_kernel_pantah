...
DECLARE_HOOK(android_vh_cpufreq_target_load,
	TP_PROTO(unsigned int *freq, struct sugov_policy *sg_policy, unsigned long util, unsigned long max),
	TP_ARGS(freq, sg_policy, util, max));
