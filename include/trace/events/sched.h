...
TRACE_EVENT(sched_find_best_target,
	...
	TP_PROTO(struct task_struct *tsk, int start_cpu,
		int best_idle, int target),

	TP_ARGS(tsk, start_cpu,	best_idle, target),
	...
	TP_printk("pid=%d comm=%s start_cpu=%d "
		  "best_idle=%d target=%d",
		__entry->pid, __entry->comm, __entry->start_cpu,
		__entry->best_idle, __entry->target)
);
