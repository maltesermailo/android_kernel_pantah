...
#define IF_HAVE_PG_HOT(flag,string) ,{1UL << flag, string}
#define IF_HAVE_PG_COLD(flag,string) ,{1UL << flag, string}
...
IF_HAVE_PG_HOT(PG_hot,			"hot"		)		\
IF_HAVE_PG_COLD(PG_cold,		"cold"		)		\
IF_HAVE_PG_HOT(PG_framework,			"framework" 	)
