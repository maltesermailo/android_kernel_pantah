...
#define WRAPFD_DEV_IOC_GET_STATE	_IOW(WRAPFD_DEV_IOC, 1, \
					     struct wrapfd_get_state)

/* ioctl for wrapfd */
#define WRAPFD_DEV_IOC_GET	_IO(WRAPFD_DEV_IOC, 2)
#define WRAPFD_DEV_IOC_PUT	_IO(WRAPFD_DEV_IOC, 3)
#define WRAPFD_DEV_IOC_REWRAP	_IOW(WRAPFD_DEV_IOC, 4, struct wrapfd_rewrap)
#define WRAPFD_DEV_IOC_EMPTY	_IO(WRAPFD_DEV_IOC, 5)
#define WRAPFD_DEV_IOC_ALLOW_GUESTS	_IO(WRAPFD_DEV_IOC, 6)
#define WRAPFD_DEV_IOC_PROHIBIT_GUESTS	_IO(WRAPFD_DEV_IOC, 7)
