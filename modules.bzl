...
def get_gki_modules_list(*args, **kwargs):
    ...
    print("""
WARNING: {caller_package}: {this_modules_bzl} is deprecated. Load get_gki_modules_list() from {new_modules_bzl} instead.""".format(
        caller_package = str(native.package_relative_label(":x")).removesuffix(":x"),
...
def get_kunit_modules_list(*args, **kwargs):
    # buildifier: disable=print
    print("""
WARNING: {caller_package}: {this_modules_bzl} is deprecated. Load get_kunit_modules_list() from {new_modules_bzl} instead.""".format(
        caller_package = str(native.package_relative_label(":x")).removesuffix(":x"),
        this_modules_bzl = str(Label(":modules.bzl")),
        new_modules_bzl = str(Label(":bazel/modules.bzl")),
    ))
