...
def get_gki_modules_list(arch = None):
    ...
    """
<<<<<<< HEAD   (ee200af4a9d0a20b4a1d4085d32156ecdf0fa10d Merge 3bb38c52719b ("Merge tag 'm68k-for-v6.17-tag1' of git:)
...
=======
    if not arch in ("arm64", "x86_64", "arm", "i386"):
        fail("{}: arch {} not supported. Use one of [arm, arm64, i386, x86_64]".format(
>>>>>>> BRANCH (1748ad54f2af989db49108a4fd6c88bba31bd1aa ANDROID: refactor get_gki_modules_list.)
