...
/**
 * Use nlmsg_readpriv as the permission for RTM_GETLINK, RTM_GETNEIGH and
 * RTM_GETNEIGHTBL messages if the netlink_route_getlink policy capability is
 * set. Otherwise use nlmsg_read.
 */
void selinux_nlmsg_init(void)
{
	u32 nl_readpriv_permission = selinux_android_nlroute_getlink() ?
			NETLINK_ROUTE_SOCKET__NLMSG_READPRIV :
			NETLINK_ROUTE_SOCKET__NLMSG_READ;

	nlmsg_set_perm_for_type(nl_readpriv_permission, RTM_GETLINK);
	nlmsg_set_perm_for_type(nl_readpriv_permission, RTM_GETNEIGH);
	nlmsg_set_perm_for_type(nl_readpriv_permission, RTM_GETNEIGHTBL);
}
