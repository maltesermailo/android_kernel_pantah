...
<<<<<<< TARGET BRANCH (3c0c9a ANDROID: Update the GKI symbol list and ABI XML am: 5a3d6440)
		char *buf = NULL;
		int i;

=======
>>>>>>> SOURCE BRANCH (95fd17 Merge tag 'android12-5.10.223_r00' into android12-5.10)
